...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public List<AvatarP2A> getAllHistoryItems() {
        ...
        int hatColorIndex = res.getColumnIndex(HISTORY_HAIR_COLOR);
        while (!res.isAfterLast()) {
            ...
            historyItem.setHairColorValue(res.getDouble(hatColorIndex));
    ...
    public List<AvatarP2A> getAllAvatarP2As() {
        ...
        p2AS.add(0, new AvatarP2A(AvatarP2A.style_art, R.drawable.head_1_male, AvatarP2A.gender_boy, "head_1/head.bundle", AvatarConstant.hairBundle("head_1", AvatarP2A.gender_boy, AvatarP2A.style_art), 2, 0));
        p2AS.add(1, new AvatarP2A(AvatarP2A.style_art, R.drawable.head_2_female, AvatarP2A.gender_girl, "head_2/head.bundle", AvatarConstant.hairBundle("head_2", AvatarP2A.gender_girl, AvatarP2A.style_art), 7, 0));
        return p2AS;
    }
