...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public List<AvatarP2A> getAllHistoryItems() {
        ...
        while (!res.isAfterLast()) {
            AvatarP2A historyItem = new AvatarP2A(res.getString(bundleDirIndex), res.getInt(genderIndex), res.getString(qBundleIndex));
    ...
    public List<AvatarP2A> getAllAvatarP2As() {
        List<AvatarP2A> p2AS = FilePathFactory.getDefaultAvatarP2As();
