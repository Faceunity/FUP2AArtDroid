package com.faceunity.pta_art.core.media;
...
public class MediaBean implements Parcelable {
    ...
    public String getSpiltMode() {
        return spiltMode;
    }

    public void setSpiltMode(String spiltMode) {
        this.spiltMode = spiltMode;
    }
